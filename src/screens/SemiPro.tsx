...
export default function SemiPro() {
  return (
    <Container>
      <HeaderTitle>SemiPro Course</HeaderTitle>
      <DescContainer>
        <FaqRow>
          <BsFillPeopleFill />
          <ShadowBox
      ...
      <StepUpCurriculum level='semiPro' />
      <OptionSelect courseName='semiPro' />
    </Container>
  );
}
